...
class Person( models.Model ):
    ...
    user_name = models.CharField( max_length = field_sizes["name_string"], unique = True, null = False,  blank = False ) 
    password = models.TextField( null = False, blank = False )
    email = models.EmailField( null = True,  blank = False,  unique = True )
    contact_number  = models.CharField( max_length = field_sizes["phone_string"], null = True,  unique = True, default = 0 ) 
